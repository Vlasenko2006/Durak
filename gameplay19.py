...
class CardPlotter(tk.Tk):
    def __init__(self, card_width, card_height, num_closed_cards, num_open_cards, deck_is_empty = False , distance=2.5, factor=1):
        super().__init__()
...
if __name__ == "__main__":
    ...
    app = CardPlotter(card_width, card_height, num_closed_cards, num_open_cards, deck_is_empty = False, factor=3)
    app.mainloop()
    # app = CardPlotter(card_width, card_height, num_closed_cards, num_open_cards, deck_is_empty = True, factor=3)
    # app.mainloop()