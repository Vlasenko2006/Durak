...
class CardPlotter(tk.Tk):
    def __init__(self, card_width, card_height, num_closed_cards, num_open_cards, distance=2.5, factor=1):
        ...
        # Create the additional frame with the same height and width equal to the width of two cards
        self.additional_frame = tk.Frame(self.frame, bg='blue', width=2 * self.card_width, height=self.card_height)
        self.additional_frame.place(relx=0.5, rely=0.5, anchor=tk.CENTER)
    ...
    def on_card_click(self, event):
        ...
        # Place the clicked card in the middle of the additional frame
        clicked_label.place(in_=self.additional_frame, relx=0.5, rely=0.25, anchor=tk.CENTER)
    ...
    def pop_card_from_top(self):
        if self.upper_card_labels:
            ...
            # Place the card in the middle of the additional frame, overlapping the last clicked card
            label.place(in_=self.additional_frame, relx=0.5, rely=0.75, anchor=tk.CENTER)
