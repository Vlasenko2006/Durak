...
class CardPlotter(tk.Tk):
    ...
    def pop_card_from_top(self):
        if self.upper_card_labels:
            ...
            middle_row = 1
            middle_column = 2
            pady_downwards_shift = int(self.card_height * 2)  # Adjust this value to shift more downwards
            label.grid(row=middle_row, column=middle_column, padx=10, pady=(self.row_spacing - pady_downwards_shift, 10))

            # Re-center the upper row and lower row after removing and adding a card
