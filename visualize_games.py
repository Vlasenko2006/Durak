...
game_log = [
    ...
    },
    {
        ...
        'step': 2,
        'trump': ('7', 'clubs'),
        'attacker_action': ('8', 'hearts'),
        'defender_action': ('Q', 'spades'),
        'remaining_attacker_hand': [('7', 'clubs'), ('K', 'diamonds'), ('9', 'diamonds'), ('8', 'diamonds')],
        'remaining_defender_hand': [('J', 'hearts'), ('K', 'spades'), ('6', 'diamonds'), ('8', 'clubs')],
        'result': 'Attacker wins'
    },
    {
        'episode': 3,
